    ...
    <Card>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={{value: agentInfo.payment_method.id, label: agentInfo.payment_method.method_name}}
                  id="payment_method"
                  name="payment_method"
                  control={control}
                  render={({ field }) => <Select 
          ...
          <div class="row">
            ...
            <Controller
                  defaultValue={{value: agentInfo.city.id, label: agentInfo.city.cities_name}}
                  id="city"
                  name="city"
                  control={control}
                  render={({ field }) => <Select 
            ...
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={{value: agentInfo.area.id, label: agentInfo.area.areas_name}}
                  id="area"
                  name="area"
                  control={control}
                  render={({ field }) => <Select 
