    ...
    if (selectedUser !== null && selectedUser?.avatar?.length) {
      ...
      return (
        <Avatar
          ...
          content={selectedUser?.policy_title}
          contentStyles={{
            borderRadius: 0,
            fontSize: 'calc(48px)',
            width: '100%',
            ...
            <div className='d-flex align-items-center flex-column'>
              ...
              <div className='d-flex flex-column align-items-center text-center'>
                <div className='user-info'>
                  <h4>{selectedUser?.policy_title}</h4>
                  
                  <Badge color={roleColors['volumetric_policy']} className='text-capitalize'>
                      {selectedUser.status}
                   </Badge>
                </div>
              </div>
          ...
          <div className='info-container'>
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'> Product:</span>
                  <span>{selectedUser?.product.product_type}</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Delivary Charge:</span>
                  <span >{selectedUser?.delivary_charge}</span>
                </li>
              </ul>
            ) : null}
          </div>
