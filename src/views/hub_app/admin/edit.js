...
const HubAdminEdit = () => {
  ...
  const [hubDetailsData, setHubDetailsData] = useState()
  ...
  const getHubDetailsData = (id) => {
    useJwt
      .axiosGet(getApi(HUB) + '/' + id + "/")
      .then((res) => {
        setHubDetailsData(res?.data)

        setValue('name', res?.data?.name)

        setValue('city', {
          value: hubDetailsData?.city?.id,
          label: hubDetailsData?.city?.city_name,
        })
        setValue('area', {
          value: hubDetailsData?.area?.id,
          label: hubDetailsData?.area?.area_name,
        })
  ...
  const onSubmit = data => {
    ...
    if (data.name !== null && data.city.value !== null && data.area.value !== null) {
      ...
      useJwt
        .axiosPatch(getApi(`${HUB}/` + id + "/"), formData)
        .then((res) => {
          ...
          <div class="row">
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  // defaultValue={hubDetailsData?.name}
                  control={control}
                  id='name'
                  name='name'
            ...
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  // defaultValue={hubDetailsData?.address}
                  control={control}
                  id='address'
                  name='address'
