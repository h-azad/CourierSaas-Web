...
import { getApi,  RIDER_EDIT, RIDER_DETAILS, PAYMENT_METHOD_LIST,CITIES_LIST,AREAS_LIST } from '@src/constants/apiUrls'
    ...
    <Card>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
          <div className='mb-1'>
            ...
            <Controller
              defaultValue={riderInfo.full_name}
              control={control}
              id='full_name'
              name='full_name'
          ...
          <div class="row">
            ...
            <Controller
              defaultValue={riderInfo.contact_no}
              control={control}
              id='contact_no'
              name='contact_no'
              render={({ field }) => (
            ...
            <Controller
              defaultValue={riderInfo.contact_optional}
              control={control}
              id='contact_optional'
          ...
          <div class="row">
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                   defaultValue={identity.find(id => id.value == riderInfo.identity)}
                   id='identity'
                   name='identity'
                  control={control}
                  render={({ field }) => <Select 
            ...
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={riderInfo.identity_no}
                  control={control}
                  id='identity_no'
                  name='identity_no'
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={{value: riderInfo.payment_method.id, label: riderInfo.payment_method.method_name}}
                  id="payment_method"
                  name="payment_method"
                  control={control}
                  render={({ field }) => <Select 
          ...
          <div class="row">
            <div class="col-lg-4">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={riderInfo.bank_name}
                  control={control}
                  id='bank_name'
                  name='bank_name'
            ...
            <div class="col-lg-4">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={riderInfo.bank_account_name}
                  control={control}
            ...
            <div class="col-lg-4">
              <div className='mb-1'>
                ...
                <Controller
                  defaultValue={riderInfo.bank_account_num}
                  control={control}
                  id='bank_account_num'
