...
import { getApi, ACCOUNT_WALLET_EDIT, ACCOUNT_WALLET_DETAILS, MARCHANT_LIST } from '@src/constants/apiUrls'
...
const EditAreas = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (data.marchant_name !== null && data.balance !== null) {
      ...
      useJwt
        .axiosPut(getApi(ACCOUNT_WALLET_EDIT + id + '/'), formData)
        .then((res) => {
