...
const defaultValues = {
  schema_name: "update_tech",
  organization_name: "UpdateTechLtd",
}
        ...
        >
          <Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
            ...
            <CardText className="mb-2">
              Please create your ogranization and start the adventure
            </CardText>
            ...
            >
              <div className="mb-1">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      autoFocus
                      placeholder="update_tech"
                      invalid={errors.organization_name && true}
                      {...field}
                    />
                  )}
                />
              ...
              <div className="mb-1">
                <div className="d-flex justify-content-between">
                  <Label className="form-label" for="schema_name">
                    Schema Name
                  </Label>
                </div>
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      autoFocus
                      placeholder="update_tech"
                      invalid={errors.schema_name && true}
                      {...field}
                    />
                  )}
                />
